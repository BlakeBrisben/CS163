...
public class GuinnessBook {
	...
	public String toString()
	{
		...
		{
			retStr += "Name: " + landAnimals.get(i).getName() + "\tTop Speed: " + landAnimals.get(i).getTopSpeed() + "\n";
		}
		return retStr;
	}
	...
	private void testGuinnessBook() throws FileNotFoundException {
        ...
        for(int i = 0; i < landAnimals.size(); i++)
        {
        	if(landAnimals.get(i).equals(new Animal("normal animal", 50)))
        	{
